...
#' \enumerate{
#'   \item Generate sampling random area effect u.Z and u.nZ with \eqn{(u.Z ~ N(0,1))} and \eqn{(u.nZ ~ N(0,1))}. The auxilary variabels are generated by Uniform distribution with \eqn{(x1 ~ U(0,1))} and \eqn{(x2 ~ U(0,1))}. The coefficient parameters \eqn{\alpha0, \alpha1, \alpha2, \beta0, \beta1, \beta2} are set as 0.
